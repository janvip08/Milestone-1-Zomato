"""Demo test for Phase 4 with Bellandur example - showing the complete pipeline."""
...
def demo_phase4_workflow():
    ...
    print(f"   Budget: ₹{preferences['max_cost_for_two']} for two")
    ...
    for i, restaurant in enumerate(filtered_restaurants, 1):
        print(f"   {i}. {restaurant['name']} - {restaurant['cuisine']} - ₹{restaurant['cost_for_two']} - ⭐{restaurant['rating']}")
    ...
    simulated_llm_response = {
        "recommendations": [
            {
                ...
                "reasons": [
                    ...
                    "Within your budget at ₹1800 for two",
            ...
            },
            {
                ...
                "reasons": [
                    ...
                    "Reasonably priced at ₹1100 for two",
            ...
            },
            {
                ...
                "reasons": [
                    ...
                    "Moderately priced at ₹1000 for two",
        ...
        "summary": f"Found 5 excellent restaurants in Bellandur matching your criteria of ₹2000 budget and 4.0+ rating. Top recommendation is Sakura Japanese Cuisine for its exceptional quality.",
        "total_matches": 5,
        "pipeline_metadata": {
            "total_candidates": 5,
            "candidates_used": 5,
    ...
    print(f"\n🍽️  STEP 3: FINAL RECOMMENDATIONS")
    print("=" * 60)
    ...
    print(f"\n🍽️  TOP 5 RESTAURANT RECOMMENDATIONS:")
    print("-" * 60)
